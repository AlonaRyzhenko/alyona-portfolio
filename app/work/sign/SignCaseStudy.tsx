                      ...
                      <div className="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-white/[0.06]">
                        <div className="p-6 flex flex-col gap-5">
                          ...
                          <img
                            ...
                            className="w-full h-auto rounded-lg border border-white/[0.06] block cursor-zoom-in transition-all duration-300 hover:opacity-90 hover:scale-[1.01] hover:border-white/30"
                          />
